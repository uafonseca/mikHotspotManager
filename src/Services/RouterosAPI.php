...
class RouterosAPI
{
    ...
    public function encrypt($string, $key=128)
    {
        $result = '';
    ...
    public function decrypt($string, $key=128)
    {
        $result = '';
    ...
    public function formatBytes($size, $decimals = 0)
    {
        $unit = array(
    '0' => 'Byte',
    '1' => 'KiB',
    ...
    public function formatBytes2($size, $decimals = 0)
    {
        $unit = array(
    '0' => 'Byte',
    '1' => 'KB',
