...
class UtilExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('formatDTM', [$this, 'formatDTM']),
            new TwigFunction('formatInterval', [$this, 'formatInterval']),
            new TwigFunction('formatBites', [$this, 'formatBites']),
    ...
    public function formatInterval($dtm)
    {
        return $this->api->formatInterval($dtm);
    }

    public function formatBites($size, $decimals = 0)
    {
